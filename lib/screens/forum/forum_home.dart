...
class _ForumHomePageState extends State<ForumHomePage> {
  ...
  Future<bool> isTopicAuthor(CookieRequest request, int topicAuthorId) async {
    final response = await request.get(
        'https://jogja-rasa-production.up.railway.app/forum/get-user-name-by-id/$topicAuthorId/');
                                  ...
                                  actions: [
                                    ...
                                    TextButton(
                                      onPressed: () async {
                                        ...
                                        try {
                                          final response = await request.get(
                                            'https://jogja-rasa-production.up.railway.app/forum/topic/${topic.pk}/delete-flutter/',
                                          );
